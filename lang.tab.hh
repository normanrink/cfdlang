...
#line 11 "lang.yy" // lalr1.cc:377

  class myFlexLexer;

#line 48 "lang.tab.hh" // lalr1.cc:377
...
namespace yy {
#line 125 "lang.tab.hh" // lalr1.cc:377
  ...
  public:
    ...
    union union_type
    {
      ...
      // paren_expr
      char dummy9[sizeof(ParenExpr *)];

      // program
      char dummy10[sizeof(Program *)];

      // stmt
      char dummy11[sizeof(Stmt *)];

      // stmt_list
      char dummy12[sizeof(StmtList *)];
  ...
  basic_symbol (typename Base::kind_type t, const BrackExpr * v);

  basic_symbol (typename Base::kind_type t, const Decl * v);

  basic_symbol (typename Base::kind_type t, const DeclList * v);

  basic_symbol (typename Base::kind_type t, const Expr * v);

  basic_symbol (typename Base::kind_type t, const ExprList * v);

  basic_symbol (typename Base::kind_type t, const Factor * v);

  basic_symbol (typename Base::kind_type t, const Identifier * v);

  basic_symbol (typename Base::kind_type t, const Integer * v);

  basic_symbol (typename Base::kind_type t, const ParenExpr * v);

  basic_symbol (typename Base::kind_type t, const Program * v);
  ...
  basic_symbol (typename Base::kind_type t, const std::string v);
    ...
    parser (myFlexLexer &lexer_yyarg, const Program *&root_yyarg);
    virtual ~parser ();
...
#line 741 "lang.tab.hh" // lalr1.cc:377


// //                    "%code provides" blocks.
#line 15 "lang.yy" // lalr1.cc:377
...
#line 758 "lang.tab.hh" // lalr1.cc:377
